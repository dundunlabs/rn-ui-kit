...
export interface AvatarProps extends Omit<Partial<ImageProps>, 'style'> {
...
export type AvatarTextProps = TextProps & Pick<AvatarProps, 'size'>
export interface AvatarTextStyles {
  sizes: Record<AvatarSize, TextStyle | null>
}

export const defaultAvatarStyles: GenericComponentStyles<Theme, AvatarProps, AvatarStyles> = {
  variants: {
    circular: {
      borderRadius: 9999
    },
